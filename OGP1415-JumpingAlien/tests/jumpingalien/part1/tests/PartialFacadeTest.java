...
public class PartialFacadeTest {
	...
	@Test
	public void testAccellerationMoving() {
		IFacade facade = new Facade();
	...
	@Test
	public void testVelocityWhenDucking() {
		IFacade facade = new Facade();
		...
		assertArrayEquals(doubleArray(1.,0.0), facade.getVelocity(alien), Util.DEFAULT_EPSILON);
	...
	public void testDuckSize() {
		...
		int normalHeight = facade.getSize(alien)[1];
		
		facade.startDuck(alien);
		facade.advanceTime(alien, 0.2);
		
		assertTrue(facade.getSize(alien)[1] < normalHeight);
