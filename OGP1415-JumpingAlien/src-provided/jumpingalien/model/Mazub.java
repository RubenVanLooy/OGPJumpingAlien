 ...
 * involving its position, velocity, and sprites.
 * 
 * @invar	The x-coordinate of any Mazub must be a valid x-coordinate
 * 			| isValidXCoordinate(GetX())
 * @invar	The y-coordinate of any Mazub must be a valid y-coordinate
 * 			| isValidYCoordinate(GetY())
 * @invar	The array of sprites of any Mazub must have a valid size, exist and each sprite must exist.
 * 			| canHaveAsNbSprites(GetNbSprites) && GetSprites() != null &&
 * 			| for each Sprite sprite in GetSprites()
 * 			|		sprite != 0
 * 
...
public class Mazub {
	 ...
	 * 			| !isValidYCoordinate
	 * 
	 * @post	The y-coordinate of this Mazub is equal to the given y-coordinate.
	 */
